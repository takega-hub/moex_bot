...
1. **Обновление данных** (автоматически, если не указан `--skip-update`):
   ...
   - Если включены MTF фичи, обновляет данные для всех нужных интервалов (базовый + 1h)
...
4. **MTF фичи** (опционально): Добавляет фичи с высших таймфреймов (1h)
