...
Использование:
    ...
    # Обучение всех моделей для всех активных инструментов на 1h с MTF (1h)
...
Примеры:
  ...
  python train_1h_models.py --ticker VBH6 --no-mtf
    ...
    print(f"🔧 MTF: {'Включено (1h)' if args.mtf else 'Выключено' if args.no_mtf else 'По умолчанию'}")
    print("=" * 80)
